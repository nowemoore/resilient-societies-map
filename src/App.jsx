          ...
          <div className="faq-list">
            ...
            <details className="faq-item">
             ...
             <details className="faq-item">
              ...
              <p className="faq-answer">Not much, which is why the author called some of the most well-read and sharp people she knows to rescue. Shout out to Maria Kostylew, Charles Dillon, and others for their thoughtful contributions.</p>
            </details>
          </div>
        </div>
      </section>
